...
entity livt_io_internalram32 is
	port(
		ctor_lvt_context_in : in t_icontext_in;
		ctor_write_enable : in std_logic_vector(3 downto 0);
		ctor_address : in std_logic_vector(10 downto 0);
		ctor_write_data : in std_logic_vector(31 downto 0);
		ctor_read_data : out std_logic_vector(31 downto 0)
	);
end;

architecture RTL of livt_io_internalram32 is
	type T_Ram is array (0 to 2047) of std_logic_vector(31 downto 0);
